...
const addTask = () => {
    ...
    taskInput.value = "";
    input.type = "type";
    editButton.innerHTML = '<i class="material-icons">eidt</i>';
...
const bindTaskEvents = (taskListItem, checkBoxEventHolder) => {
    const checkBox = taskListItem.querySelector("input[type=checkbox");
    const editButton = taskListItem.querySelector("button.edit");
    const deleteButton = taskListItem.querySelector("button.delete");

    checkBox.addEventListener("change", checkBoxEventHolder);
